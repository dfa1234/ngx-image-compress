...
describe('AppComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [{provide: NgxImageCompressService, useValue: mockNgxImageCompressService}]
    }).compileComponents();
  ...
  it('should compress file', async () => {
    (mockNgxImageCompressService.uploadFile as jasmine.Spy).and.returnValue(Promise.resolve({
  ...
  it('should upload multiple files', async () => {
    (mockNgxImageCompressService.uploadMultipleFiles as jasmine.Spy).and.returnValue(Promise.resolve([
      {
  ...
  it('should upload, compress and resize at a maximum side', async () => {
    (mockNgxImageCompressService.uploadFile as jasmine.Spy).and.returnValue(Promise.resolve({
